...
import { query_page_list, retrieve_block, retrieve_page, create_page } from './wrappedAPI';
...
export const handleRawPage = (rawPage) => {
  return {
    ...
    isCommentHidden: rawPage?.properties?.isCommentHidden?.checkbox,
    isDateHidden: rawPage?.properties?.isDateHidden?.checkbox,
    isTitleHidden: rawPage?.properties?.isTitleHidden?.checkbox,
    isHeadHidden: rawPage?.properties?.isHeadHidden?.checkbox,
  };
};
/**
