...
export const Quote = ({ quote, children }) => {
  ...
  return (
    <div
      className={`mt-2 pl-4 ${colors.default} ${colors.default} ${colors[color]} border-l-4 ${border_color.default} ${border_color[color]} rounded whitespace-pre-wrap break-words max-w-full min-w-[1px]`}>
